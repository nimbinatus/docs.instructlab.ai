...
const targetNode2 = document.querySelector(".md-sidebar--secondary");
...
const observer2 = new MutationObserver(function (mutations) {
    if (targetNode2) {
        ...
        console.log("the chat container now exists");
        let chatbot = run_me_2();
    } else {
        console.log("the element never existed");
    }
});
...
function run_me_2() {
    ...
    chatbot.setAttribute("class", "chatbot md-sidebar__scrollwrap");
    chatbot.append("here's text");
    sidebar.appendChild(chatbot);
    return sidebar;
}